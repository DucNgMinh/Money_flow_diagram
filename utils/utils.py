...
def sub_table(df, highlighted_nodes, selected_columns, size_column, map_tt_color, page_flag):
    ...
    sub_fig = sankey_graph(highlighted_df, selected_columns, highlighted_nodes, 
                            title= "Highlighted", size_column= size_column, color_map= map_tt_color)
...
def graph(df, selected_columns, size_column, highlighted_nodes, color_map, title, page_flag):
    ...
    st.plotly_chart(fig)
    if len(highlighted_nodes) != 0:
        sub_table(sub_df, highlighted_nodes, selected_columns, 
                    size_column, color_map, page_flag = page_flag)
